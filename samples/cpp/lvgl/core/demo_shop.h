...
#include <widgets/lv_demo_widgets_components.h>

LV_IMAGE_DECLARE(img_clothes);

namespace demo {

	inline lv_obj_t* chart3 = nullptr;

	inline void shop_chart_event_cb(lv_event_t* e)
	{
		LV_UNUSED(e);
	}

	inline lv_obj_t* create_shop_item(lv_obj_t* parent, const void* img_src, const char* name, const char* category, const char* price);

	inline void shop(lv_obj_t* parent)
	{
